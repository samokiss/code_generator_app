...
class OrganizationListItemResponseStub2 extends OrganizationListItemResponseDTO
{
    public const CREATED_AT = OrganizationStub2::CREATED_AT;

    public const DESCRIPTION = OrganizationStub2::DESCRIPTION;

    public const ID = OrganizationStub2::ID;

    public const LOGO = OrganizationStub2::LOGO;

    public const NAME = OrganizationStub2::NAME;

    public const UPDATED_AT = OrganizationStub2::UPDATED_AT;
